...
Each conflict action is also assigned an intensity whereby different scales are used. Here, I use the upper range of the CAMEO scale which is used to classify conflict actions (greater than 9). Tab. 2 shows all levels (lvl0) and sublevels (lvl1) from the intensity scale including a short description. I only use the top level of the scale to determine the intensity of conflict actions.
