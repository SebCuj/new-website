...
Looking at the identified conflict events (Tab. 1), the acting parties are associated with a country (Source/Target.Country) and then further specified by a name (Source/Target.Name). For many events, however, the country´s name is only provided as a specification. In addition, there is no distinction between intrastate or interstate conflict events. 
